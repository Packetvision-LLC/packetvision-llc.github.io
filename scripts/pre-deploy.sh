#!/bin/bash
# Pre-deployment validation for packetvision.net (PACV)
...
log "🚀 packetvision.net Pre-Deploy Validation Starting..."
...
# Check for common files (Packetvision site structure)
REQUIRED_FILES=("dist/index.html" "dist/about/index.html" "dist/services/index.html" "dist/contact/index.html")
